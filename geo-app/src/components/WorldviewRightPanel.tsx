    ...
    return (
        ...
        >
            ...
            <div className="bg-black/40 backdrop-blur-md border border-gray-800 rounded-xl pointer-events-auto border-r-2 border-r-cyan-900 flex flex-col relative overflow-hidden h-full">
                ...
                {/* Header / Toggle */}
                <div
                    className="flex justify-between items-center p-4 min-h-[44px] cursor-pointer hover:bg-gray-900/50 transition-colors border-b border-gray-800/50"
                    onClick={() => setIsMinimized(!isMinimized)}
                >
                    <span className="text-[10px] text-gray-500 font-mono tracking-widest">DISPLAY CONFIG</span>
                    <button className="w-11 h-11 md:w-auto md:h-auto flex items-center justify-center text-gray-500 hover:text-white transition-colors">
                    ...
                    {!isMinimized && (
                        ...
                        >
                            <div className="flex flex-col gap-6 p-4 pt-4">
                                ...
                                <button
                                    className="w-full border border-red-900/30 bg-red-950/10 rounded py-3 min-h-[44px] mt-2 text-[10px] font-mono tracking-widest text-red-500 hover:text-white hover:bg-red-900 hover:border-red-600 transition-all font-bold"
