...
async def live_data_fast(request: Request):
    ...
    payload = {
        ...
        "iss_position": d.get("iss_position"),
    }
...
async def live_data_slow(request: Request):
    ...
    payload = {
        ...
        "wildfires": d.get("wildfires", []),
        "natural_events": d.get("natural_events", []),
        "weather_stations": d.get("weather_stations", []),
        "space_weather": d.get("space_weather", []),
        "carbon_intensity": d.get("carbon_intensity"),
        "submarine_cables": d.get("submarine_cables", []),
        "ebird_sightings": d.get("ebird_sightings", []),
        "purpleair": d.get("purpleair", []),
        "cyber_threats": d.get("cyber_threats", []),
        "events": d.get("events", []),
        "fishing_activity": d.get("fishing_activity", []),
        "newsapi": d.get("newsapi", []),
        "finnhub": d.get("finnhub", {}),
    }
...
async def health_check():
    ...
    return {
        ...
        "sources": {
            ...
            "cctv": len(d.get("cctv", [])),
            "news": len(d.get("news", [])),
            "wildfires": len(d.get("wildfires", [])),
            "natural_events": len(d.get("natural_events", [])),
            "weather_stations": len(d.get("weather_stations", [])),
            "submarine_cables": len(d.get("submarine_cables", [])),
        },
